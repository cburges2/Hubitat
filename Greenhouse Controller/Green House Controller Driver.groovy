...
metadata {
	definition (
		...
		command "setChartFrame", [[type:"TEXT",description:"Set Button Text", defaultValue:"Temperature"],[type:"TEXT",description:"Set URL", defaultValue: ""],[type:"TEXT",description:"Set Height px", defaultValue:"600px"],[type:"TEXT",description:"Set Width px", defaultValue:"1230px"]
		,[type:"TEXT",description:"Set Left Pos %", defaultValue:"2%"],[type:"TEXT",description:"Set Top Pos %", defaultValue:"5%"]]
		command "setChartFrame2", [[type:"TEXT",description:"Set Button Text", defaultValue:"Energy"],[type:"TEXT",description:"Set URL", defaultValue: ""],[type:"TEXT",description:"Set Height px", defaultValue:"475px"],[type:"TEXT",description:"Set Width px", defaultValue:"546px"]
		,[type:"TEXT",description:"Set Left Pos %", defaultValue:"2%"],[type:"TEXT",description:"Set Top Pos %", defaultValue:"5%"]]		
}
