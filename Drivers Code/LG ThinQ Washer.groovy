...
def setDisplay() {
    String display = "Run Time: "+(device.currentValue("runTimeDisplay"))+"<br>Remain Time: "+(device.currentValue("remainingTimeDisplay"))+"<br>Course: "+(device.currentValue("smartCourse"))+"<br>State: "+(device.currentValue("currentState"))
    String display2 = "Soil Level: "+(device.currentValue("soilLevel"))+"<br>Spin Speed: "+(device.currentValue("spinSpeed"))+"<br>Temp: "+(device.currentValue("temperature"))+"<br>Remote Start: "+(device.currentValue("remoteStart")) 
    sendEvent(name: "display", value: display)
    sendEvent(name: "display2", value: display2)
}

def setPresence(currentState) {
    sendEvent(name: "presence", value: currentState)
}
