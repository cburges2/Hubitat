...
metadata {
    definition (
        ...
        capability "ChangeLevel"      // water level
        capability "Actuator"
    ...
    preferences {
        ...
        input( name: "inchesPerHour", type:"NUMBER", title: "Inches of water used per Hour", defaultValue: 0.72)
        input( name: "fullInches", type:"NUMBER", title: "Tank depth in Inches", defaultValue: 16.25)
        input( name: "fullOunces", type:"NUNMBER", title: "Tank volume in Ounces", defaultValue: 235.0)
    }
}
...
def setLevel(value, rate = null) {
    ...
    BigDecimal runMinutes = new BigDecimal(state?.inchesUsed * inchesPerHour)
...
def setVolume(setpoint) {
    ...
    sendEvent(name: "humidifyingSetpoint", value: setpoint, descriptionText: getDescriptionText("humidifyingSetpoint set to ${level}"))
