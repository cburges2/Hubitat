...
def setDisplay() {
    ...
    String display2 = "Dry Level: "+(device.currentValue("dryLevel"))+"<br>Time Dry: "+(device.currentValue("timeDry"))+"<br>Temp: "+(device.currentValue("temperatureLevel")) //+"<br>)Remote Start: "+(device.currentValue("remoteStart")) 
