...
def setDisplay() {
    ...
    String display = "Humidity: "+ device.currentValue("humidity")+"%<br> Setpoint: "+ device.currentValue("humidifyingSetpoint")+"%<br> Water: "+device.currentValue("waterLevel")+"%<br> "+device.currentValue("operatingState")
