/**
 *  ****************  Echo Speaks Alexa Switch Connectors  ****************
 *
 *  Usage:
 *  This was designed to control up to five virtual Switches from Hubitat using the speak text command in Echo Speaks App to control Alexa Devices
 *
**/

definition (
    name: "Echo Speaks Alexa Switch Connectors",
    namespace: "Hubitat",
    author: "Burgess",
...
def switchHandler(evt) {
    ...
    def cmd = action + " " + virtualSwitch.getName()
    logDebug("cmd = $cmd")
