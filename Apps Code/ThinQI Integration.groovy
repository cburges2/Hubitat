...
def prefCertRefresh() {
	return dynamicPage(name: "prefCert", title: "LG ThinQ OAuth", nextPage: "prefDevicesRefresh", uninstall:false, install: false) {
		//section {
            ...
            state.certSource = "Use Cloud Service"
		//}
	}
...
def PrefDevicesRefresh() {
	if (state.certSource == "Use Cloud Service") {
		generateKeyAndCSR()
	}
...
def reRegister() {
    runIn(21600, prefDevicesRefresh)
}
